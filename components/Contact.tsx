...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-slate-50 dark:bg-[#020617] relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-5xl md:text-5xl font-black text-slate-900 dark:text-white leading-tight mb-6">
              Let's build <br />
              <span className="text-amber-500 text-glow-sm">something great.</span>
            </h2>
            ...
            <div className="space-y-4">
               <div className="flex items-center gap-4 text-slate-700 dark:text-slate-300">
                  ...
                  <span className="font-medium text-lg">waleedtechdev09@gmail.com</span>
               </div>
            </div>
          </motion.div>
